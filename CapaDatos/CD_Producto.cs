                        ...
                        while (dr.Read())
                        {
                            lista.Add(
                                new Producto()
                                {
                                    ...
                                    oCategpria = new Categoria() { IdCategoria = Convert.ToInt32(dr["IdCategoria"]), Descripcion = dr["DesCategoria"].ToString() },
        ...
        public int Registrar(Producto obj, out string Mensaje)
        {
            ...
            try
            {
                using (SqlConnection oconexion = new SqlConnection(Conexion.cn))
                {
                    ...
                    cmd.Parameters.AddWithValue("IdCategoria", obj.oCategpria.IdCategoria);
