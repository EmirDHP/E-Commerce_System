...
namespace CapaNegocio
{
    public class CN_Usuarios
    {
        ...
        public int Registrar(Usuario obj, out string Mensaje)
        {
            ...
            {
                Mensaje = "El nombre de usuario no puede ser varcio";
            }
            ...
            if (string.IsNullOrEmpty(Mensaje))
            {
                ...
                //string mensaje_correo = "<h3>Su cuenta fue creada correctamente</h3></br><p>Su contrasena para acceder es: !clave!</p>";
